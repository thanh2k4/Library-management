...
public class BookLoanService {
        ...
        public BaseGetAllResponse<BookLoanResponse> getAllBookLoans(BookLoanGetAllRequest request) {
                ...
                List<BookLoanResponse> bookLoanResponseList = bookLoanRepository
                                .findAllByFilters(userId, bookTitle, status)
                                .stream()
                                .skip(skipCount)
        ...
        public BookLoanResponse requestBorrow(BookLoanRequestBorrowRequest request) {
                BookCopy bookCopy = bookCopyRepository
                                .findFirstByBookIdAndStatus(request.getBookId(), BookCopyStatus.AVAILABLE)
        ...
        public BookLoanResponse requestReturn(BookLoanRequestReturnRequest request) {
                ...
                bookLoan.setActualReturnDate(
                                request.getActualReturnDate() != null ? request.getActualReturnDate() : new Date());
                bookLoan = bookLoanRepository.save(bookLoan);
